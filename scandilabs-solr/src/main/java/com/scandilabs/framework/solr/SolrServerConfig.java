...
public class SolrServerConfig {
    ...
    private static Logger logger = LoggerFactory
            .getLogger(SolrServerConfig.class.getName());
    ...
    /**
     * Initializes the SolrServer. Must be called before use.
     * instance
     */
    public void init() {
        ...
        try {
            ...
            solrServer = new CommonsHttpSolrServer(String.format(
                    "http://%s:%d/solr/", solrHost, solrPort));
            ...
            logger.error("could not create the SolrServer bean on:"
                    + solrServer + ":" + solrPort + "with error:"
                    + malUrlException.getLocalizedMessage());
        } catch (Exception e) {
